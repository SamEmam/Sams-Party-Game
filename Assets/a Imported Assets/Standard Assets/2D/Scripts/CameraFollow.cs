...
namespace UnityStandardAssets._2D
{
    public class CameraFollow : MonoBehaviour
    {
        ...
        public Vector3 maxXAndYAndZ; // The maximum x and y and z coordinates the camera can have.
        public Vector3 minXAndYAndZ; // The minimum x and y and z coordinates the camera can have.
        ...
        {
            // By default the target x and y coordinates of the camera are it's current x and y and z coordinates.
            ...
            // The target x and y and z coordinates should not be larger than the maximum or smaller than the minimum.
