...
{
    public float hoverHeightStart = 3F;
    private float hoverHeight;
    public float hoverRaise = 6F;
    public float hoverLower = 1F;
    ...
    void Update()
    {
        ...
        {
            hoverHeight = hoverRaise;
        }

        else if (Input.GetButton("Lower"))
        {
            hoverHeight = hoverLower;
        }

        else
        {
            hoverHeight = hoverHeightStart;
        }
